...
(function (_) {
    ...
    function accessContent(tab, data) {
        ...
        if (scriptInTab[tab.id] === undefined) {
            ...
            if(data.data.showABTest){
                var index = libs.css.indexOf("common/ui/css/extension.css");
                if (index > -1) {
                    libs.css.splice(index, 1);
                }
                if(libs.css.indexOf("common/ui/css/extensionAB.css") == -1){
                    libs.css.push("common/ui/css/extensionAB.css");
                }
            }else{
                var index = libs.css.indexOf("common/ui/css/extensionAB.css");
                if (index > -1) {
                    libs.css.splice(index, 1);
                }
  ...
  _.extend(AvastWRC.bs.SP, // Browser specific
  {
    ...
    init: function (balInst) {
      balInst.modifyInjectLibs( function(injectLibs) {
          ...
          //injectLibs.libs.push('common/libs/avast_1_6_min.js'); // add F1rstOffer parsing lib
          return injectLibs;
        }
      );
    }
